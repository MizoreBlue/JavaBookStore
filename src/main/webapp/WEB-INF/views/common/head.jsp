...
<div class="top-bar">
  <div class="container">
    ...
    <!-- 右侧：链接 -->
    <div class="top-links">
      <a href="${pageContext.request.contextPath}/cart?action=view" title="查看购物车">
      ...
      <c:if test="${empty sessionScope.user}">
        <a href="${pageContext.request.contextPath}/user?action=login" title="用户登录">用户登录</a>
      </c:if>
      ...
      <c:if test="${not empty sessionScope.user}">
        ...
        <!-- 显示头像 -->
        <a href="${pageContext.request.contextPath}/user?action=profile" title="个人中心">
        ...
        <a href="${pageContext.request.contextPath}/user?action=logout" title="退出登录">退出</a>
      </c:if>
